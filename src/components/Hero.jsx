  ...
  return (
    <Section id='hero' className='pt-[12rem] -mt-[5.25rem]' crosses crossesOffset='lg:translate-y-[5.25rem]' customPaddings>
        <div className='container relative' ref={parallaxRef}>
            <div className='relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]'>
                <h1 className='h1 mb-6'>
                    ...
                    <span className='inline-block relative'>Brainwave{" "}
                        <img src={curve} alt="curve" className='absolute top-full left-0 w-full xl:-mt-2' width={628} height={28}/>
                    </span>
                </h1>
                    ...
                    <div className='relative bg-n-8 rounded-[1rem]'>
                        ...
                        <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]'>
                            ...
                            <ScrollParallax isAbsolutelyPositioned>
                                <ul className='hidden absolute -left-[5.5rem] bottom-[7.5rem] px-1 py-1 bg-n-9/45 backdrop-blur border border-n-1/10 rounded-2xl xl:flex'>
            ...
            <CompanyLogos className='hidden relative z-10 nt-10 lg:block' />
        </div>
        <BottomLine />
    </Section>
  )
